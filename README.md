...
# BLE-сканер с триангуляцией и картой
...
Автор форка: Костин Арсений (@arskstn)
Автор прошлой версии прошивки: Максим Симдянов (@NotoriusM)
Автор изначального проекта: Общество с ограниченной ответственностью «Открытая мобильная платформа», документация изначального проекта лежит в директории с приложением.
